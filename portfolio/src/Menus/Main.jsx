...
<p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto mix-blend-difference">
 Exploring the world of MERN Stack Development, one project at a time! Passionate about turning ideas into reality through code. Let’s collaborate and build something incredible together! 
</p>
 <div className="flex justify-center items-center gap-2 mt-4">
   
     <button className=" mix-blend-difference inline-flex  text-white items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-primary-foreground shadow h-9 w-24 p-4 bg-transparent hover:bg-transparent mt-4 border "><div>
     <a  className="mix-blend-difference"  href="https://www.linkedin.com/in/contact-neha-meena/">
