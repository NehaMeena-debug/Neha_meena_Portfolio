...
const Main = ()=>{
    function launchHDConfetti() {
        ...
        setTimeout( () =>{
           window.open("https://www.linkedin.com/in/contact-neha-meena/");
        }, 1500);
    }
return(
    <>
...
Aspiring Frontend Developer, passionate about building dynamic and engaging web experiences. Let’s collaborate and build something amazing together! 
 ...
 <div className="flex justify-center items-center gap-2 mt-4">
     ...
     <button   onClick={() => launchHDConfetti()}  className=" mix-blend-difference inline-flex  relative text-white items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-primary-foreground shadow h-9 w-18 p-4 bg-transparent hover:bg-transparent mt-4 border border-gray-700 ">
     <div>
